...
export default function Home() {
  ...
  }, [page, search, category, fragile, sortField, sortOrder, limit]);
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      if (isEdit) {
        await axios.put(
          `http://localhost:8080/api/products/${modalProduct._id}`,
          modalProduct,
          { headers }
        );
      } else {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <main className="max-w-5xl mx-auto pt-10 px-4 sm:px-6 lg:px-8">
        <HeaderBar onLogout={handleLogout} />

        <ProductInventoryHeader total={products.length} onAdd={handleAdd} />
        ...
        <div className="flex justify-center mt-4 space-x-2">
          ...
          {Array.from({ length: totalPages }, (_, i) => (
            <button
              key={i}
              onClick={() => setPage(i + 1)}
              className={`px-4 py-1 rounded font-bold border ${
                page === i + 1
          ...
          >
            ...
            <div className="mb-5 flex items-center space-x-3">
              <input
                ...
                onChange={(e) =>
                  setModalProduct({ ...modalProduct, fragile: e.target.checked })
                }
              />
              <label
                htmlFor="fragile"
            ...
            <div className="mb-5">
              ...
              <input
                ...
                onChange={(e) =>
                  setModalProduct({ ...modalProduct, quantity: Number(e.target.value) })
                }
                required
              />
            </div>
            <div className="mb-8">
              ...
              <input
                ...
                onChange={(e) =>
                  setModalProduct({ ...modalProduct, cost: Number(e.target.value) })
                }
                required
              />
            </div>
